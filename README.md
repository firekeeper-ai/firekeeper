...
Options:
      --base <BASE>
          Base commit to compare against. Examples: HEAD^ or ^, HEAD~1 or ~1, commit hash, @{1.day.ago}, HEAD for uncommitted changes [default: HEAD if uncommitted changes exist, otherwise ^]
      --log-level <LOG_LEVEL>
