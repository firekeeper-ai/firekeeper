...
pub fn truncate_text_by_chars(content: String, start: usize, len: usize) -> String {
...
pub fn truncate_text_by_lines(content: String, start: usize, len: usize) -> String {
...
pub fn truncate_single_line(content: String, max_len: usize) -> String {
    let total_len = content.len();
...
mod tests {
    ...
    fn test_truncate_single_line_with_truncation() {
        ...
        assert_eq!(result, "hello... [truncated 5/11 chars]");
    }
}
